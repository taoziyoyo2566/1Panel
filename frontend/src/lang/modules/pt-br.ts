...
const message = {
    ...
    xpack: {
        ...
        tamper: {
            tamper: 'Integridade do Site',
            tamperHelper1:
                'Para sites de implantação com um clique, é recomendado habilitar o recurso de anti-alteração do diretório de aplicativos. Se o site apresentar mau funcionamento ou falha no backup/restauração, desative primeiro o recurso de anti-alteração.',
            tamperHelper2:
                'Isso irá restringir as operações de leitura, gravação, exclusão, modificação de permissões e alteração de proprietário de arquivos protegidos em diretórios não excluídos.',
            op: 'Operação',
            create: 'Criar',
            file: 'Arquivo',
            tamperPath: 'Diretório Protegido',
            tamperPathEdit: 'Modificar Caminho',
            log: 'Logs de Interceptação',
            totalProtect: 'Proteções Totais',
            todayProtect: 'Proteções de Hoje',
            addRule: 'Adicionar Regra',
            ignore: 'Excluir Diretório',
            ignoreHelper: 'Uma entrada por linha, por exemplo: \ntmp\n./tmp',
            ignoreHelper1: 'Adicione nomes de pastas ou caminhos específicos para excluir da proteção.',
            ignoreHelper2: 'Use caminhos relativos começando com ./ para excluir pastas específicas.',
            protect: 'Arquivo Protegido',
            protectHelper: 'Uma entrada por linha, por exemplo: \npng\n./test.css',
            protectHelper1: 'Especifique nomes de arquivos, extensões ou arquivos específicos para proteger.',
            protectHelper2: 'Use caminhos relativos começando com ./ para proteger arquivos específicos.',
            enableHelper:
        ...
        alert: {
            ...
            clamsRulesHelper: 'Tarefas de varredura de vírus que exigem alertas por SMS',
            ...
            sendTimeRange: 'Intervalo de tempo para envio de SMS',
