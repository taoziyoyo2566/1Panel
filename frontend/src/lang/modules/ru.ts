    ...
    xpack: {
        ...
        tamper: {
            ...
            ignoreTemplateHelper:
                'Введите содержание исключения (конкретный файл или каталог ./log, имя каталога tmp, расширение файла .html, тип файла js), разделенные Enter или пробелом.',
            protectTemplateHelper:
                'Введите содержание защиты (конкретный файл ./index.html, расширение файла .html, тип файла js), разделенные Enter или пробелом.',
            ...
            ignore: 'Исключить каталог/файл',
            ignoreHelper:
                'Выберите или введите содержание исключения (конкретный файл или каталог ./log, имя каталога tmp, расширение файла .html, тип файла js), разделенные Enter или пробелом.',
            protect: 'Защитить файл',
            protectHelper:
                'Выберите или введите содержание защиты (конкретный файл ./index.html, расширение файла .html, тип файла js), разделенные Enter или пробелом.',
            tamperHelper01:
            ...
            tamperHelper02:
                'Все файлы в исключенных каталогах не будут ограничены, если в защищенных файлах не указаны конкретные пути к файлам (наивысший приоритет);',
            tamperHelper03:
