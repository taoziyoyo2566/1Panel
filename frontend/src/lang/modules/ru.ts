    ...
    xpack: {
        ...
        tamper: {
            ...
            ignoreTemplateHelper:
                'Введите содержание исключения (имя каталога tmp, расширение файла .html, тип файла js), разделенные Enter или пробелом.',
            protectTemplateHelper:
                'Введите содержание защиты (расширение файла .html, тип файла js), разделенные Enter или пробелом.',
