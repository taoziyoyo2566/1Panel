...
const message = {
    ...
    license: {
        ...
        closeAlert: 'Эту страницу можно скрыть в настройках панели',
        ...
        app: 'Обновите до профессиональной версии, чтобы управлять серверами и просматривать функции мониторинга через мобильное приложение.',
    },
    clean: {
