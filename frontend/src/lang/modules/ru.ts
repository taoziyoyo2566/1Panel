...
const message = {
    ...
    xpack: {
        ...
        tamper: {
            tamper: 'Целостность сайта',
            tamperHelper1:
                'Для веб-сайтов с типом развертывания в один клик рекомендуется включить функцию защиты от модификации для каталогов приложения. Если сайт работает с ошибками или резервное копирование/восстановление не удается, сначала отключите функцию защиты от модификации.',
            tamperHelper2:
                'Будут ограничены операции чтения, записи, удаления, изменения прав доступа и владельца для защищённых файлов в каталогах, не включенных в исключения.',
            op: 'Операция',
            create: 'Создать',
            file: 'Файл',
            tamperPath: 'Защищённый каталог',
            tamperPathEdit: 'Изменить путь',
            log: 'Логи перехвата',
            totalProtect: 'Всего защит',
            todayProtect: 'Сегодняшние защиты',
            addRule: 'Добавить правило',
            ignore: 'Исключить каталог',
            ignoreHelper: 'Одна запись на строку, например: \ntmp\n./tmp',
            ignoreHelper1: 'Добавьте имена папок или конкретные пути для исключения из защиты.',
            ignoreHelper2: 'Используйте относительные пути, начинающиеся с ./, чтобы исключить конкретные папки.',
            protect: 'Защищённый файл',
            protectHelper: 'Одна запись на строку, например: \npng\n./test.css',
            protectHelper1: 'Укажите имена файлов, расширения или конкретные файлы для защиты.',
            protectHelper2: 'Используйте относительные пути, начинающиеся с ./, чтобы защитить конкретные файлы.',
            enableHelper:
        ...
        alert: {
            ...
            clamsRulesHelper: 'Задачи сканирования на вирусы, требующие SMS уведомлений',
            ...
            sendTimeRange: 'Временной интервал отправки SMS',
