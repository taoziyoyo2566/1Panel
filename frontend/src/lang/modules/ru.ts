...
const message = {
    ...
    xpack: {
        ...
        node: {
            ...
            panelExist:
                'Служба 1Panel уже существует на этом узле. Пожалуйста, обновитесь до V2 с помощью скрипта обновления перед добавлением!',
            coreExist:
            ...
            uninstallHelper: 'Будет удалена служба 1Panel дочернего узла и связанные данные. Выбирайте осторожно!',
