...
const message = {
    ...
    xpack: {
        ...
        tamper: {
            tamper: 'Integriti Laman Web',
            tamperHelper1:
                'Untuk laman web jenis penyebaran satu klik, disyorkan untuk mengaktifkan ciri anti-pemalsuan direktori aplikasi. Jika laman web mengalami masalah atau pemulihan/gantian gagal, sila matikan ciri anti-pemalsuan terlebih dahulu.',
            tamperHelper2:
                'Ia akan menghadkan operasi pembacaan, penulisan, penghapusan, dan pengubahsuaian kebenaran serta pemilik bagi fail yang dilindungi di bawah direktori yang tidak dikecualikan.',
            op: 'Operasi',
            create: 'Cipta',
            file: 'Fail',
            tamperPath: 'Direktori Terlindung',
            tamperPathEdit: 'Ubah Laluan',
            log: 'Log Halangan',
            totalProtect: 'Jumlah Perlindungan',
            todayProtect: 'Perlindungan Hari Ini',
            addRule: 'Tambah Peraturan',
            ignore: 'Kecualikan Direktori',
            ignoreHelper: 'Satu entri setiap baris, contohnya \ntmp\n./tmp',
            ignoreHelper1: 'Tambah nama folder atau laluan khusus untuk dikecualikan daripada perlindungan.',
            ignoreHelper2: 'Gunakan laluan relatif yang bermula dengan ./ untuk mengecualikan folder tertentu.',
            protect: 'Fail Dilindungi',
            protectHelper: 'Satu entri setiap baris, contohnya \npng\n./test.css',
            protectHelper1: 'Tentukan nama fail, sambungan fail, atau fail tertentu untuk dilindungi.',
            protectHelper2: 'Gunakan laluan relatif yang bermula dengan ./ untuk melindungi fail tertentu.',
            enableHelper:
        ...
        alert: {
            ...
            log: 'Log Sandaran',
            snapshot: 'Snapshot Sistem',
            clamsRulesHelper: 'Tugas imbasan virus yang memerlukan amaran SMS',
            ...
            sendTimeRange: 'Hantar julat masa SMS',
